...
export default function PropertyPanel({
  ...
  const handleBorderChange = (
    ...
    property: "color" | "width" | "style",
    value: string | number
  ) => {
    const borderKey = `border${side}` as keyof typeof selectedElement.style;
    const currentBorder = (selectedElement.style?.[borderKey] as {
      color: string;
      width: number;
      style: string;
  ...
  const handleBorderRadiusChange = (
    ...
    if (!isNaN(numValue) && numValue >= 0) {
      const radiusKey =
        `border${corner}Radius` as keyof typeof selectedElement.style;
      onUpdateElement(selectedElement.id, {
        style: {
          ...(selectedElement.style || {}),
          [radiusKey]: numValue,
    ...
    <div className='h-full overflow-y-auto p-4'>
      <div className='space-y-6'>
        ...
        {selectedElement.type === "image" && (
          <div>
            <h4 className='text-sm font-medium mb-2'>画像設定</h4>
            <div className='space-y-3'>
              {!selectedElement.imageSettings?.src ? (
                <div>
                ...
                <div className='space-y-2'>
                  <div>
                    ...
                    <p className='text-sm truncate'>
                      {selectedElement.imageSettings.fileName || "無題"}
                    </p>
                  </div>
                  ...
                  <div className='flex gap-2 flex-wrap'>
                    ...
                    <button
                      ...
                      className='px-3 py-1 text-xs border rounded text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20'
                    >
                      画像削除
                    </button>
                  </div>
        ...
        <div>
          ...
          <div className='space-y-3'>
            {(["Top", "Right", "Bottom", "Left"] as const).map((side) => {
              const borderKey =
                `border${side}` as keyof typeof selectedElement.style;
              const currentBorder = (selectedElement.style?.[borderKey] as {
                color: string;
                width: number;
                style: string;
                  ...
                  <div className='grid grid-cols-3 gap-2'>
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleBorderChange(side, "color", e.target.value)
                        }
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          handleBorderChange(side, "style", e.target.value)
                        }
                        className='w-full px-1 py-1 text-xs border rounded dark:bg-gray-700 dark:border-gray-600'
                      >
